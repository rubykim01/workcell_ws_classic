...
ros2 run gazebo_ros spawn_entity.py -file "$OBJECTS_DIR/mobile_tray_h1.sdf" -entity mobile_tray_h1 -x $TRAY_H1_X -y $TRAY_H1_Y -z $TRAY_H1_Z &
ros2 run gazebo_ros spawn_entity.py -file "$OBJECTS_DIR/mobile_tray_h2.sdf" -entity mobile_tray_h2 -x $TRAY_H2_X -y $TRAY_H2_Y -z $TRAY_H2_Z &
ros2 run gazebo_ros spawn_entity.py -file "$OBJECTS_DIR/mobile_tray_h3.sdf" -entity mobile_tray_h3 -x $TRAY_H3_X -y $TRAY_H3_Y -z $TRAY_H3_Z &
ros2 run gazebo_ros spawn_entity.py -file "$OBJECTS_DIR/mobile_tray_h4.sdf" -entity mobile_tray_h4 -x $TRAY_H4_X -y $TRAY_H4_Y -z $TRAY_H4_Z &
ros2 run gazebo_ros spawn_entity.py -file "$OBJECTS_DIR/mobile_tray_h5.sdf" -entity mobile_tray_h5 -x $TRAY_H5_X -y $TRAY_H5_Y -z $TRAY_H5_Z &
wait
...
ros2 run gazebo_ros spawn_entity.py -file "$OBJECTS_DIR/heating_plate1.sdf" -entity heating_plate_t2_1st -x $Plate_T2_X_1ST -y $Plate_T2_Y_1ST -z $Plate_T2_Z_1ST &
ros2 run gazebo_ros spawn_entity.py -file "$OBJECTS_DIR/heating_plate2.sdf" -entity heating_plate_t2_2nd -x $Plate_T2_X_2ND -y $Plate_T2_Y_2ND -z $Plate_T2_Z_2ND &
ros2 run gazebo_ros spawn_entity.py -file "$OBJECTS_DIR/heating_plate1.sdf" -entity heating_plate_t5_1st -x $Plate_T5_X_1ST -y $Plate_T5_Y_1ST -z $Plate_T5_Z_1ST &
ros2 run gazebo_ros spawn_entity.py -file "$OBJECTS_DIR/heating_plate2.sdf" -entity heating_plate_t5_2nd -x $Plate_T5_X_2ND -y $Plate_T5_Y_2ND -z $Plate_T5_Z_2ND &
wait
